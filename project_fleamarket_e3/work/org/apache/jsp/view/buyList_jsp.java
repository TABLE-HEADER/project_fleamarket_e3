 ...
 * Generated at: 2022-06-24 02:31:01 UTC
...
if(user == null){
 ...
 if(authority.equals("")){ 
      ...
      out.write("\t\t<!-- contents -->\r\n");
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t\t<h2 style=\"margin:15px auto 10px;\">購入一覧</h2>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
...
switch(deal.getState()) {
      ...
      out.print(request.getContextPath());
      out.write("/buyList?changeid=");
      out.print(deal.getDealid() );
      out.write("'\">入金完了</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<button disabled>入金完了</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
