 ...
 * Generated at: 2022-06-24 02:57:10 UTC
...
if(productname.equals("") && category.equals("")) {
      out.write("\r\n");
      out.write("\t\t\t\t\t\t全件表示（");
      out.print(deal_list != null ? deal_list.size() : 0);
      out.write("件）\r\n");
      out.write("\t\t\t\t\t");
}
					else{
      ...
      out.print(deal.getTotal() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"center\" width=\"100\">");
      out.print(deal.getPaid_at() != null ? deal.getPaid_at() : "&nbsp;");
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"center\" width=\"100\">");
      out.print(deal.getSent_at() != null ? deal.getSent_at() : "&nbsp;");
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t");
