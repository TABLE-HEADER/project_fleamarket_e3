 ...
 * Generated at: 2022-06-27 04:43:01 UTC
...
if(user == null){
 ...
 if(authority.equals("")){ 
      ...
      out.write("\t\t<!-- contents -->\r\n");
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t\t<h2 style=\"margin:15px auto 10px;\">マイ出品一覧</h2>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
...
if(productname.equals("") && category.equals("")) {
      out.write("\r\n");
      out.write("\t\t\t\t\t\t全件表示（");
      out.print(product_list != null ? product_list.size() : 0);
      out.write("件）\r\n");
      out.write("\t\t\t\t\t");
}
					else{
      ...
      out.write("\t\t\t\t</caption>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th bgcolor=\"#6666ff\" width=\"50\" colspan=\"2\">&nbsp;</th>\r\n");
      ...
      out.write("\t\t\t\t\t<th bgcolor=\"#6666ff\" width=\"100\">登録日</th>\r\n");
      out.write("\t\t\t\t\t<th bgcolor=\"#6666ff\" width=\"150\" colspan=\"2\">出品状況</th>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"center\" width=\"50\"><a href=\"");
      out.print(request.getContextPath());
      out.write("/myProductDetail?productid=");
      out.print(product.getProductid() );
      out.write("\">[編集]</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"center\" width=\"50\"><a href=\"#\" onclick=\r\n");
      out.write("\t\t\t\t\t\t\t\"if(window.confirm('「");
      out.print(product.getProductname() );
      out.write("」を削除してもよろしいですか？')){\r\n");
      out.write("\t\t\t\t\t\t\t\tlocation.href = '");
      out.print(request.getContextPath());
      out.write("/myProductList?deleteid=");
      out.print(product.getProductid() );
      out.write("'\r\n");
      out.write("\t\t\t\t\t\t\t}\">[削除]</a></td>\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td align=\"center\" width=\"100\">");
      out.print(product.getCreated_at() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t");
if(product.getOn_sale()) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<td bgcolor=\"skyblue\" width=\"100\">出品中<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(request.getContextPath());
      out.write("/myProductList?changeid=");
      out.print(product.getProductid() );
      out.write("'\">出品取消</button>\r\n");
      out.write("\t\t\t\t\t\t\t");
}
							else {
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<td bgcolor=\"wheat\" width=\"100\">出品待ち<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(request.getContextPath());
      out.write("/myProductList?changeid=");
      out.print(product.getProductid() );
